...
# === CONFIG ===
SOURCE_DIR = Path("/home/ml164/YOLO/dataset2")
FAIL_IMAGES_DIR = SOURCE_DIR / "xray-dataset-08152025/Fail"
PASS_IMAGES_DIR = SOURCE_DIR / "xray-dataset-08152025/Pass"
LABELS_DIR = SOURCE_DIR / "labels"

DEST_DIR = Path("/home/ml164/YOLO/data2")
...
pairs = []
for img_path in sorted(FAIL_IMAGES_DIR.iterdir()):
...
for img_path in sorted(PASS_IMAGES_DIR.iterdir()):
    if img_path.suffix.lower() not in IMG_EXTS:
        continue
    lbl_path = LABELS_DIR / f"{img_path.stem}.txt"
    cls_ids = parse_label_file(lbl_path)
